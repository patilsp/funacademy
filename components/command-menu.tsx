  ...
  return (
    <>
      <button
        ...
        {...props}
      >
        <Search className="mb-2 size-7 rounded-md border border-input bg-transparent p-1 shadow-sm hover:bg-accent hover:fill-black hover:text-slate-900 dark:text-white dark:hover:fill-white" />
      </button>
