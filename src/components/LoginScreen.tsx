...
export const LoginScreen = ({
  ...
  return (
    <article
      className={[
        "fixed inset-0 z-30 flex flex-col bg-surface p-7 text-ink transition duration-300",
    ...
    >
      <header className="flex flex-row-reverse justify-between sm:flex-row">
        <button
          className="flex text-ink-faint transition-colors hover:text-ink"
        ...
        <button
          className="fa-btn-secondary-sm hidden sm:block"
          onClick={() =>
      ...
      <div className="flex grow items-center justify-center">
        <div className="flex w-full flex-col gap-5 sm:w-96">
          <h2 className="fa-h2 text-center">
              ...
              <>
                <div className="relative flex grow">
                  ...
                  <div className="absolute bottom-0 right-0 top-0 flex items-center justify-center pr-4">
                    <div
                      className="relative flex h-6 w-6 cursor-pointer items-center justify-center rounded-full border-2 border-line text-ink-faint"
                    ...
                    >
                      ?
                      {ageTooltipShown && (
                        <div className="fa-card absolute -right-5 top-full z-10 w-72 p-4 text-center text-xs leading-5">
                          Providing your age ensures you get the right funacademy
                          experience. For more details, please visit our{" "}
                          <Link
                            href="https://www.funacademy.com/privacy"
          ...
          <div className="flex items-center gap-2">
            <div className="h-[2px] grow bg-line"></div>
          ...
          <p className="fa-caption text-center text-xs">
            By signing in to funacademy, you agree to our{" "}
            <Link
              className="font-bold text-brand"
              href="https://www.funacademy.com/terms?wantsPlainInfo=1"
            >
              Terms
            </Link>{" "}
            and{" "}
            <Link
              className="font-bold text-brand"
              href="https://www.funacademy.com/privacy?wantsPlainInfo=1"
            >
              Privacy Policy
            </Link>
            .
          ...
          <p className="block text-center sm:hidden">
            ...
            <button
              className="text-sm font-bold uppercase text-brand"
              onClick={() =>
                setLoginScreenState((x) => (x === "LOGIN" ? "SIGNUP" : "LOGIN"))
              }
            >
